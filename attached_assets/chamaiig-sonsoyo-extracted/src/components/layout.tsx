...
import { PhoneCall, XCircle, Sparkles } from "lucide-react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col w-full max-w-md mx-auto shadow-2xl relative md:max-w-4xl overflow-hidden"
